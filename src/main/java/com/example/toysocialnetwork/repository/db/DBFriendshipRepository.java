...
import com.example.toysocialnetwork.repository.memory.MemoryFriendshipRepository;
...
public class DBFriendshipRepository extends MemoryFriendshipRepository {
    ...
    public List<Long> getFriendshipRequestsSent(Long id) {
    ...
    public void confirm(Long id1, Long id2) {
